...
$(function() {
    ...
    var countries = new Bloodhound({
        ...
        prefetch: {
            ...
            url: '/static/assets/demo_data/typeahead/countries.json',
    ...
    var bestPictures = new Bloodhound({
        datumTokenizer: Bloodhound.tokenizers.obj.whitespace('value'),
        queryTokenizer: Bloodhound.tokenizers.whitespace,
        prefetch: '/static/assets/demo_data/typeahead/movies.json',
        remote: '/static/assets/json/queries/%QUERY.json'
    });
