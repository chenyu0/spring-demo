...
<div class="navbar navbar-default header-highlight">
    <div class="navbar-header">
        <a class="navbar-brand" href="/"><img src="/static/assets/images/logo_light.png" alt=""></a>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-content width-350">
                    ...
                    <ul class="media-list dropdown-content-body">
                        ...
                        <li class="media">
                            <div class="media-left"><img src="/static/assets/images/placeholder.jpg"
            ...
            <li class="dropdown dropdown-user">
                <a class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span>${response['user']['realName']}</span>
                    <i class="caret"></i>
                </a>
...
<div class="page-container">
    ...
    <div class="page-content">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-user">
                    <div class="category-content">
                        <div class="media">
                            <a href="#" class="media-left"><img src="/static/assets/images/placeholder.jpg"
                                                                class="img-circle img-sm" alt=""></a>
                            <div class="media-body">
                                <span class="media-heading text-semibold">${response['user']['realName']!'admin'}</span>
                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <!-- Main -->
                            <li class="navigation-header"><span>导航栏</span> <i class="icon-menu" title="Main pages"></i>
                            </li>
                                ...
                                <#list response['menus'] as parent>
                                    ...
                                    <#if parent['parentCode']?number == 0>
                                        ...
                                        <li>
                                            <a href="javascript:switchMenu('${parent['menuUrl']}',this);"><i
                                                    class="${parent['icon']!'icon-home4'}"></i>
                                                <span>${parent['menuName']}</span></a>
                                        <#assign menuIndex = 0/>
                                        <#list response['menus'] as child>
                                            <#if child['parentCode']?number != 0 && child['parentCode'] ==  parent['menuCode']>
                                                ...
                                                <li><a href="javascript:switchMenu('${child['menuUrl']}');"><i
                                                        class="${child['icon']!'icon-files-empty'}"></i>${child['menuName']}
                                                </a></li>
        ...
        <!-- Main content -->
        <div style="width: 84.9%;height: 100%;position:absolute;">

            <!-- Content area -->
            <div style="height: 100%;width: 100%">

                <div id="content" style="padding: 0; width: 100%; height: 99%;margin-bottom: 20px;"
                     align="center"></div>
